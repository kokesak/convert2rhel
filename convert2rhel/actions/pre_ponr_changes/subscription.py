    ...
    def run(self):
        ...
        try:
            ...
            if not subscription_manager_pkgs:
                ...
                # may require newer versions of packages than provifed by the vendor.
            ...
            if toolopts.tool_opts.no_rhsm:
                ...
                try:
                    ...
                    if "not yet registered" in str(e):
                        message = (
                            "You either need to register this system via subscription-manager"
                            " before running convert2rhel or give convert2rhel credentials to do that for"
                            " you. The credentials convert2rhel would need are either"
                            " activation_key and organization or username and password.  You can set"
                            " these in a config file and then pass the file to convert2rhel with the"
                            " --config-file option."
                        )
